										...
										<td align="left" valign="top">
											...
											>
												<span
													style="
														...
														letter-spacing: -1.5px;
													"
													>Se vendió un producto desde la Página Web!</span
												>
											</font>
											<div
												style="
											...
											>
												<span
													style="
														...
														line-height: 32px;
													"
													>Un cliente compró el/los siguientes productos. Toda la información de esta venta se encuentra disponible en el panel de control.</span>
											</font>
											<div
												style="
													height: 20px;
											...
											>
												<table>
													...
													"
													>{{$sale['title']}}, $ {{number_format($sale['unit_price'], 2, ',', '.')}}, x{{$sale['amount']}} unidad/es</span>
														</td>
													</tr>
													@endforeach
												</table>
